...
const envSchema = z.object({
  ...
  BILLING_BANK_NAME: z.string().optional().default(''),
  BILLING_BANK_ACCOUNT_NUMBER: z.string().optional().default(''),
  BILLING_BANK_ACCOUNT_HOLDER: z.string().optional().default(''),
  SENTRY_DSN: z.string(),
...
const parseEnvironment = () => {
  try {
    ...
    return envSchema.parse({
      ...
      BILLING_BANK_ACCOUNT_NUMBER: process.env.BILLING_BANK_ACCOUNT_NUMBER,
      BILLING_BANK_ACCOUNT_HOLDER: process.env.BILLING_BANK_ACCOUNT_HOLDER,
